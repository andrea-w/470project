...
def capital_expenditure_ratio(data):
    new_df = data.assign(Capital_Expenditure_Ratio = lambda x: x.capital_expenditure/x.total_expenditure)
    return new_df
...
def other_expenditure_rater(data):
    new_df = data.assign(Other_Expenditure_Ratio = lambda x: x.other_expenditure/x.total_expenditure)
    return new_df
